// CrashTestDummyDlg.cpp : implementation file
//
...
// CCrashTestDummyDlg dialog




CCrashTestDummyDlg::CCrashTestDummyDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CCrashTestDummyDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CCrashTestDummyDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CCrashTestDummyDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
...
// CCrashTestDummyDlg message handlers

BOOL CCrashTestDummyDlg::OnInitDialog()
{
...
void CCrashTestDummyDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CCrashTestDummyDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CCrashTestDummyDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

typedef struct __CrashTestDummy_DummyStruct {
	int dummyInt;
	TCHAR dummyStr;
	float dummyFloat;
	double dummyDouble;
...
void CCrashTestDummyDlg::OnBnClickedCancel()
{
	OnCancel();
	exit(255);
}
